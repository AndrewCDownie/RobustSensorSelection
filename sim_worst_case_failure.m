function [obj_rand,obj_greedy,obj_ram,X,Xr,Xg,Xram,error_rand,error_greedy,error_ram] = sim_worst_case_failure(time_size,n,A,C,V,M_start,V_start,M_end,V_end, start_loc,end_loc,k,beta)
 ...
 for t = 1:time_size
    ...
    % remove sensors
    reduced_sensors = remove_worst_case(t,Pr,Pr_k_k_1,C,V,sensors,beta);
 ...
 for t = 1:time_size
    ...
    %remove sensors
    reduced_sensors = remove_worst_case(t,Pg,Pg_k_k_1,C,V,sensors,beta);
 ...
 for t = 1:time_size
    ...
    %Remove Sensors
    reduced_sensors = remove_worst_case(t,Pram,Pram_k_k_1,C,V,sensors,beta);
